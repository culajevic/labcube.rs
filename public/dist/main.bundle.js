...
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); // changing analysis number color on hover
...
window.onload = function () {
  ...
  if (location.match('addAnalysis')) {
    ...
    removeItems.removeElement(parentUl, analysisSelected); // search for connected Diseases and adding them to the DOM
