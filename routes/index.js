...
router.delete(
  "/profile/:id/:location?",
  authenticationController.deleteOtherResult
);
...
router.post(
  "/schedule/:labId/:analysis/:userId/:total",
  scheduleController.scheduleVisit
);
...
router.get(
  "/interpretation/page/:page",
  scheduleController.resultsInterpretation
);
router.get(
  "/otherResultsInterpretation/page/:page",
  scheduleController.otherResultsInterpretation
);
router.get(
  "/interpretation/:id",
  scheduleController.resultsInterpretationValues
);
router.get(
  "/otherResultsInterpretation/:id",
  scheduleController.otherResultsInterpretationValues
);
router.post(
  "/analysisInterpretation/:id",
  scheduleController.analysisInterpretation
);
router.post(
  "/analysisOtherInterpretation/:id",
  scheduleController.analysisOtherInterpretation
);
router.post("/lockTheInterpretation", scheduleController.lockTheInterpretation);
router.post(
  "/lockTheOtherInterpretation",
  scheduleController.lockTheOtherInterpretation
);
...
router.get(
  "/search/analysis/:analysisName/:labSlug",
  labController.getAdditionalAnalysis
);
...
router.post(
  "/sendFeedbackForLabCube/:id",
  resultController.sendFeedbackLabCube
);
...
router.get(
  "/deleteApprovedComment/:labId/:commentId",
  labController.deleteApprovedComment
);
...
router.get(
  "/analysis/prices/:analysisName",
  analysisController.getAnalyisisNameResult
);
//get analysis name for interpretaion result page
router.get(
  "/getAnalysisName/:analysisName",
  analysisController.getAnalysisNameForInterpretation
);
...
router.get("/sve-laboratorije-u-Srbiji", labController.getListOfLabs);
